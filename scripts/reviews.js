...
window.onload = function () {
    ...
    console.log('reviews  js');
    var tblReviews = document.getElementById('table-reviews');
    var tblReviewsBody = tblReviews.getElementsByTagName('tbody')[0];
    ...
    inputSearch.addEventListener('input', function (event) {
        ...
        var tableRows = tblReviewsBody.children
    ...
    sortBtnsArray.forEach(function (btn) {
        btn.addEventListener('click', function (event) {
            var tableRows = Array.from(tblReviewsBody.children);
