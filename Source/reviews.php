    ...
    <div class="GradientBg">
        <div class="row">
            <div class="col-md-8 offset-2">
                <h2 class="paddingTop TitleReviews">View Reviews</h2>
                ...
                <table id="table-reviews" class="table table-hover">
                    <thead>
                        <tr>
                            <th><a href="#" class="btn-sort" data-column="gameId">Game Id</a></th>
                            <th><a href="#" class="btn-sort" data-column="positivity">Positivity</a></th>
                            <th><a href="#" class="btn-sort" data-column="userName">User Name</a></th>
                            <th><a href="#" class="btn-sort" data-column="review">Review</a></th>
                            <th><a href="#" class="btn-sort" data-column="posted">Posted</a></th>
                            <th>actions</th>
                        </tr>
                    </thead>
                    <tbody id="tblReviewsBody">
                        ...
                        <tr data-id="<?= $review->id ?>">
                            <td class="cell gameId">
                                <p><a href="singleGamePage.php?id=<?= $review->gameId ?>" class="btn-link">
                                        <?= $review->gameId ?>
                                    </a></p>
                            </td>
                            <td class="cell positivity">
                                <p>
                                    <p><?= $review->positivity?></p>
                            </td>
                            ...
                            <td class="cell posted">
                                <p>
                                    <p><?= $review->posted ?></p>
                            </td>

                            <td>
                                <a class="btn btn-warning" href="reviews_edit.php?id=<?= $review->id ?>">Edit</a>
                                <a class="btn btn-danger delete" href="reviews_delete.php?id=<?= $review->id ?>">Delete</a>
                            </td>
                        </tr>
                        <?php } ?>
                    </tbody>
                ...
                <?php } ?>
                <p><a class="btn btn-primary" href="reviews_create.php">Create</a></p>
            </div>
        </div>
