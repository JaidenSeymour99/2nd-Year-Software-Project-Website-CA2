...
<body>
    ...
    <div class="container-fluid TopNavBackground background">
        <div class="row">
            <div class="col-lg-1 col-sm-12 offset-lg-3 offset-sm-0">
                <a href="index.php">
                    <div class="row">
            ...
            <!--Login Buttons-->
            <div class="col-lg-1 col-sm-8 offset-sm-0">
                <div class="row">
                    <?php
        ...
        if (!is_logged_in()) {
            echo '<div class="col-lg-7 col-sm-4 RegisterPadding">';
            echo '<a class="btn btn-secondary btn-sm" href="registerForm.php"><h3 class="Login">Register</h3></a>';
            echo '</div>';
            echo '<div class="col-lg-5 col-sm-2 LoginPadding">';
    ...
    <div class="container-fluid ">
        <div class="row background">
            ...
            <!--Making Second nav-->
            <div class="col-lg-4 col-sm-12 offset-lg-1 offset-sm-0 paddingTop">

                <nav class="navbar navbar-dark bg-dark">
                    <a class="navbar-brand" href="#">Backend</a>
                    <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent01" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
                        <span class="navbar-toggler-icon"></span>
                    </button>
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-sm-12 paddingTop bgTop">
                <a href="singleGamePage.php?id=<?= $game02->id ?>">
                    <div class="topImageHolder">
                        <img src="<?= $game02->posterImage ?>" height="540" width="940" style="max-width:120%">
                    </div>
                </a>
            </div>
            <div class=" col bgTop"></div>
    ...
    <div class="container-fluid GradientBg">
        <div class="row">
            <div class="col-lg-3 col-sm-11 offset-lg-3 offset-sm-1">
        ...
        <div class="row">
            <div class="col-lg-4 col-sm-12 offset-lg-3 lg-paddingLeft sm-paddingLeft">
                <a href="singleGamePage.php?id=<?= $game01->id ?>">
                    <div>
                        <img src="<?= $game01->posterImage ?>" height="420" width="620" style="max-width:100%">
                    </div>
                </a>
            </div>
            <div class="col-lg-2 col-sm-10 offset-lg-0 offset-sm-1 BoxBg">
                <a href="singleGamePage.php?id=<?= $game01->id ?>">
        ...
        <div class="row bigBotPadding">
            ...
            <div class="col-lg-2 col-sm-12 offset-lg-3 offset-sm-3">
                <div class="row paddingLeft">
                    <a href="singleGamePage.php?id=<?= $game05->id ?>">
                        <div>
                            <img src="<?= $game05->posterImage ?>" height="260" width="300" style="max-width:100%">
                        </div>

                    </a>
                </div>
                <div class="row">
                    <div class="col-lg col-sm-9 paddingLeft specialOffer01Bg">
                ...
                <div class="row specialOffer01Bg">
                    ...
                    <a href="allGames.php" class="DiscountBg">
                        <div class="col-5 DiscountBg ">
                            <h3 class="altaltDiscountText">10~70%</h3>
                        </div>
                    </a>
                    <div class="col"></div>
                </div>
            ...
            <!--            CARD 2-->
            <div class="col-lg-2 col-sm-12 offset-lg-0 offset-sm-3">
                <div class="row paddingLeft">

                    <a href="singleGamePage.php?id=<?= $game10->id ?>">
                        <div>
                            <img src="<?= $game10->posterImage ?>" height="295" width="300" style="max-width:100%">
                        </div>
            ...
            <!--            CARD 3 AND 4-->
            <div class="col-lg-2 col-sm-9 offset-lg-0 offset-sm-3 BoxBg paddingLeft paddingRight">
    ...
    <div class="container-fluid background">
        ...
        <!--        CARD 1-->
        <div class="row">
            <div class="col-lg-2 col-sm-6 offset-lg-3 offset-sm-3 paddingLeft">
            ...
            <div class="col-lg-2 col-sm-10 offset-lg-0 offset-sm-1 topSellingBg">
