...
<body>
    ...
    <div class="container-fluid GradientBg">
        ...
        <div class="row paddingbottom">
            <div class="col-6 offset-3 paddingTitle paddingbottom">
                <div class="row BuyGameNameNow ">
                    ...
                    <div class="col-6">
                        <h3 class="BuyGameNameNowText reviewPaddingBot">You have successfully purchased <?= $game->gameName?>. Thank you for shopping with us!</h3>

                    </div>
                    <div class="col-2 offset-4 paddingTop">
                        <a class="btn btn-block btn-success" href="index.php" role="button">Home</a>
                    </div>
                </div>
        ...
        <div class="paddingsmallbottom"></div>
